...
const FormAutocompleteSelector = ({ control, name, options, label = '', rules = {}, multiple = false}: Props) => {
  return (
    <Controller
      name={name}
      control={control}
      ...
      render={({ field: { onChange, value }, fieldState: { error } }) => (
        <Autocomplete
          ...
          renderOption={(props, option: FormSelectorOption) => [props, option] as React.ReactNode}
